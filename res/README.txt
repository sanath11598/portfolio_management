...
16. Create Portfolio with SIP:
    This feature is only available through the GUI.
    A new SIP portfolio is created by taking a portfolio name, a comma separated list of tickers, their weights by percentage, a starting date,
